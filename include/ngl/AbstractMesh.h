...
public :
  ...
  /// @returns a std::vector containing the vert data
  //----------------------------------------------------------------------------------------------------------------------
  glm::vec3 getVertexAtIndex( uint32_t _i ) const noexcept
  {
  ...
  //----------------------------------------------------------------------------------------------------------------------
  glm::vec3 getSphereCenter() const  noexcept{return m_sphereCenter;}
  //----------------------------------------------------------------------------------------------------------------------
  /// @brief accesor to get the bounding sphere center
  //----------------------------------------------------------------------------------------------------------------------
  ...
  //----------------------------------------------------------------------------------------------------------------------
  glm::vec3 getCenter() const  noexcept{return m_center;}
  //----------------------------------------------------------------------------------------------------------------------
